            ...
            <div className="bg-[#09090b] rounded-3xl border border-white/10 overflow-hidden shadow-2xl group">
              ...
              <div className="relative bg-[#050505] aspect-video flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 pointer-events-none bg-black/40">
                  ...
                  <div className="text-zinc-400/80 text-xs mt-3 italic font-mono">Add your second video src attribute above</div>
                </div>
              </div>
              <div className="p-6 border-t border-white/5 bg-white/[0.01]">
                <div className="text-zinc-100 font-bold text-base mb-1 font-outfit">MIDI Edit Demo — Before &amp; After</div>
                <div className="text-zinc-500 text-sm">33-bar melody → 5-voice cinematic arrangement</div>
              </div>
            </div>
          </div>
